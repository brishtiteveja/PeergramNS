                                ...
                                <StackLayout paddingTop="5" backgroundColor="#E8E8E8">
                                    <StackLayout class="postContainer">
                                        ...
                                        <StackLayout orientation="horizontal"
                                            ...
                                            <Label text=" " style="font-size:22;margin-left:23%;margin-top:-3;color:#747474;"
                                                class="font-awesome" />
                    ...
                    <StackLayout dock="bottom" height="10%" style="border-color:#E4E4E4;border-width:1;background:#fff;">
                        <StackLayout orientation="horizontal">
                            ...
                            <StackLayout class="navItem" @tap="conversationsTap()">
                                <Label text="1" android:class="notificationAndroid"
        ...
        data() {
            return {
                ...
                homePosts: [{
                        ...
                        postImg: "~/assets/images/bday.png",
                        likes: "30",
                        comments: "14",
                        reposts: "8"
                    },
                    {
                        ...
                        color: "#E15050",
                        date: "Today at 16:21",
                        title: "I Love California 🌞",
                        postImg: "~/assets/images/cali.png",
                        likes: "150",
                        comments: "21",
                        reposts: "11"
                    }
